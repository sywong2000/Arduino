...
float magCalibration[3] = {0, 0, 0}, magBias[3] = {0, 0, 0},magScale[3];  // Factory mag calibration and mag bias
...
void setup()
{
  ...
  if (c == 0x71) // WHO_AM_I should always be 0x68
  {
    ...
    Serial.print("Gyro bias = " + String(gyroBias[0]) + "," + String(gyroBias[1]) + "," + String(gyroBias[2]));
    Serial.print("Accel bias = " + String(accelBias[0]) + "," + String(accelBias[1]) + "," + String(accelBias[2]));
...
void loop()
{
  ...
  else
  {
    ...
    if (delt_t > 100) { // update LCD once per half-second independent of read rate
      ...
      //      Serial.print("\t");
      //      Serial.print(ax*80,8);
      //      Serial.print("\t");
      //      Serial.print(ay*80,8);
      //      Serial.print("\t");
      //      Serial.print(az*80,8);
      //      Serial.print("\t");
      //      Serial.print("\t");
